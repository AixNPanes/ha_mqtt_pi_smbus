...
class TestPiBME280(TestCase):
    ...
    def test_pi_bme280_normal(self, mock_flask, mock_client, mock_device, mock_bme280, mock_parser):
    ...
    def test_pi_bme280_atexit(self, mock_flask, mock_client, mock_device, mock_bme280, mock_parser, mock_atexit_register):
        sys.modules.pop("example.pi_bme280.pi_bme280", None)
